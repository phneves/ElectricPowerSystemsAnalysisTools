...
Dados \left\{    \begin{array}{lll}
    ...
    \label{rede1_dados}
\end{equation}
\subsection{Equacionamento: Método de Newton}
...
\subsubsection{Processo iterativo (subsistema 1)}
Tem-se:
\begin{equation}
  \left\{    \begin{array}{llll}
                V_2=1pu\\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Solução por software: Metodo de Newton}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Solução por software: Metodo de Newton desacoplado rápido}
...
\subsection{Solução por software: Método de Newton}
...
\subsection{Solução por software: Método de Newton desacoplado}
...
\begin{figure}[!htb]
    \centering
    \subfloat[Barra 2]{{\includegraphics[width=5cm]{figuras/IEEE14_fig2.png} }}%
    \qquad
    \subfloat[Barra 3]{{\includegraphics[width=5cm]{figuras/IEEE14_fig3.png} }}%
    \qquad
    \subfloat[Barra 4]{{\includegraphics[width=5cm]{figuras/IEEE14_fig4.png} }}%
    \qquad
    \subfloat[Barra 5]{{\includegraphics[width=5cm]{figuras/IEEE14_fig5.png} }}%
...
\begin{figure}[!htb]
    \centering
    \subfloat[Barra 6]{{\includegraphics[width=4cm]{figuras/IEEE14_fig6.png} }}%
    \qquad
    \subfloat[Barra 7]{{\includegraphics[width=4cm]{figuras/IEEE14_fig7.png} }}%
    \qquad
    \subfloat[Barra 8]{{\includegraphics[width=4cm]{figuras/IEEE14_fig8.png} }}%
    \qquad
    \subfloat[Barra 9]{{\includegraphics[width=4cm]{figuras/IEEE14_fig9.png} }}%
    \qquad
    \subfloat[Barra 10]{{\includegraphics[width=4cm]{figuras/IEEE14_fig10.png} }}%
    \qquad
    \subfloat[Barra 11]{{\includegraphics[width=4cm]{figuras/IEEE14_fig11.png} }}%
    \qquad
    \subfloat[Barra 12]{{\includegraphics[width=4cm]{figuras/IEEE14_fig12.png} }}%
    \qquad
    \subfloat[Barra 13]{{\includegraphics[width=4cm]{figuras/IEEE14_fig13.png} }}%
    \qquad
    \subfloat[Barra 14]{{\includegraphics[width=4cm]{figuras/IEEE14_fig14.png} }}%
